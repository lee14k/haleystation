...
const ThreePhotoRowTwo = ({ photoOne, photoTwo, photoThree, textOne, textTwo, textThree}) => {
    ...
    const renderContent = (photo, text1, text2, text3) => {
        ...
        return (
          <div className={`flex flex-col h-300 w-300 items-center justify-center rounded bg-gray-200 ${text1 || text2 || text3 ? 'border-4 border-gray-500' : ''}`}>
    ...
    return (
        <div className="flex flex-col justify-evenly items-evenly ">
