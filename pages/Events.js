      ...
      <div>
        <div className="grid grid-cols-2 text-yellow-950 green-box py-12 px-4">
          <div className="flex justify-center items-center flex-col">
            ...
            <div className={lora.className}>
              <p className="tracking-widest text-white text-2xl">
                No matter what you’re celebrating, let Haley Station be the
                venue for your special day. Here are some of the events we’re
                happy to help you host: Weddings and Wedding Receptions - More
                Info about Weddings at Haley Station Bridal and Baby Showers
                Graduation Parties Birthday Parties Company Parties and
                Trainings Banquets and Benefits Have an event not listed here?
                Get in contact with us today to find out how we can host at
                Haley Station.
              </p>
